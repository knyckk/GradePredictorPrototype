...
public class Topics extends javax.swing.JFrame {
     ...
     */
    public Topics() {
        topics = DatabaseManipulation.getTopicsFromSubject(GradePredictor.getSubject());
        initComponents();
    }
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        if (ValidationRoutines.presenceCheck(newTopicFld.getText()) && ValidationRoutines.lengthCheck(0, newTopicFld.getText(), 128)) {//validates new topic
            int maxID = DatabaseManipulation.createTopic(newTopicFld.getText(), GradePredictor.getSubject());//stores new topic
    ...
    private void replaceBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_replaceBtnActionPerformed
        if (ValidationRoutines.presenceCheck(replaceFld.getText()) && ValidationRoutines.lengthCheck(0, replaceFld.getText(), 128) && replaceBox.getSelectedItem() != null) {//validates changed topic 
            if (DatabaseManipulation.updateTopic(replaceBox.getSelectedItem().toString(), replaceFld.getText(), GradePredictor.getSubject())) {//stores changed topic and checks if change occured
    ...
    private void removeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeBtnActionPerformed
        if (removeBox.getSelectedItem() != null) {
            if (DatabaseManipulation.deleteTopic(topics.get(removeBox.getSelectedIndex()).getID(), GradePredictor.getSubject())) {//deletes the topic
