...
public class StudentProfile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        iconLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/profile"+(GradePredictor.getStudent().getIcon()+1)+".jpeg")));

        iconBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Icon 1", "Icon 2", "Icon 3", "Icon 4", "Icon 5", "Icon 6", "Icon 7" }));
        iconBox.setSelectedIndex(GradePredictor.getStudent().getIcon());
        ...
        nameLbl.setText("Name: " + GradePredictor.getStudent().getName());

        usernameLbl.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        usernameLbl.setText("Username: " + GradePredictor.getStudent().getUsername());
    ...
    private void enterBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterBtnActionPerformed
        if (subjectBox.getSelectedItem() != null) {
            GradePredictor.setSubject(subjectBox.getSelectedIndex() + 1, subjectBox.getSelectedItem().toString()); //sets subject to the subject being entered
            GradePredictor.setBoundaries(GradePredictor.getSubject()); //gets the average grade boundaries for the subject
            DatabaseManipulation.createStudentSub(GradePredictor.getStudent(), GradePredictor.getSubject()); //creates the student subject in the database
    ...
    private void enterBtnKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_enterBtnKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) { //if enter key is pressed does the same code as enterBtnActionPerformed
            GradePredictor.setSubject(subjectBox.getSelectedIndex() + 1, subjectBox.getSelectedItem().toString());
            GradePredictor.setBoundaries(GradePredictor.getSubject());
            DatabaseManipulation.createStudentSub(GradePredictor.getStudent(), GradePredictor.getSubject());
    ...
    private void iconBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_iconBoxItemStateChanged
        ...
        GradePredictor.setStudentIcon(iconBox.getSelectedIndex()); //sets the icon locally
        DatabaseManipulation.updateUserIcon(iconBox.getSelectedIndex(), GradePredictor.getStudent().getEmail()); //stores new icon value
