...
public class TopicBreakdown extends javax.swing.JFrame {
    ...
    public TopicBreakdown() {
        ...
        uniqueQuestions = DatabaseManipulation.subjectQuestions(GradePredictor.getSubject()); //gets all questions
        questionIndex = 0;
        questionIndex1 = 0; //initialises variables
        topics = new ArrayList<>();
        for (int i = 0; i < questions.size(); i++) {
            if ((GradePredictor.contains(topics, questions.get(i).getTopic()) == -1)) {
    ...
    public void setLabels() {//sets left labels
        ...
        if (count > 0 && marks > 0) {
            ...
            gradeLbl.setText("Topic Grade: " + GradePredictor.grade(percentage / count));
        } else {
    ...
    public void setLabels1() {//method to perform the same action as setLabels, but on right components rather than left
        ...
        if (count > 0 && marks > 0) {
            ...
            gradeLbl1.setText("Topic Grade: " + GradePredictor.grade(percentage / count));
        } else {
