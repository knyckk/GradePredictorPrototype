...
public class ClassForm extends javax.swing.JFrame {
    ...
    private void studentBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_studentBtnActionPerformed
        if (studentsBox.getSelectedItem() != null) {
            GradePredictor.setViewing(true); //when a teacher chooses to view a student sets a boolean to flag that as true
            GradePredictor.setStudent(students.get(studentsBox.getSelectedIndex()));//sets the student to the student the teacher selected
