...
public class TeacherProfile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        iconLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/profile"+(GradePredictor.getTeacher().getIcon()+1)+".jpeg")));

        iconBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Icon 1", "Icon 2", "Icon 3", "Icon 4", "Icon 5", "Icon 6", "Icon 7" }));
        iconBox.setSelectedIndex(GradePredictor.getTeacher().getIcon());
        ...
        usernameLbl.setText("Username: " + GradePredictor.getTeacher().getUsername());
        ...
        nameLbl.setText("Name: " + GradePredictor.getTeacher().getName());
    ...
    private void enterBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterBtnActionPerformed
        if (subjectBox.getSelectedItem() != null) {
            GradePredictor.setSubject(subjectBox.getSelectedIndex() + 1, subjectBox.getSelectedItem().toString());//enters subject selected
    ...
    private void iconBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_iconBoxItemStateChanged
        ...
        GradePredictor.setTeacherIcon(iconBox.getSelectedIndex());//updates icon image when changed
        DatabaseManipulation.updateUserIcon(iconBox.getSelectedIndex(), GradePredictor.getTeacher().getEmail());
