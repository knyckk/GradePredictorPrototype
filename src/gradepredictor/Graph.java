...
public class Graph extends JPanel {
    ...
    ArrayList<Double[]> coordinates = DatabaseManipulation.getPercentages(GradePredictor.getStudent(), GradePredictor.getSubject(), new Date(GradePredictor.getStudent().getDate())); //sets coordinates to be the percentage in a paper for y and date for x
    int mar = 40; //margin
