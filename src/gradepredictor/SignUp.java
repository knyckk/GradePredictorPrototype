...
public class SignUp extends javax.swing.JFrame {
    ...
    private void enterBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterBtnActionPerformed
        if (ValidationRoutines.lengthCheck(0, passwordFld.getText(), 64) && ValidationRoutines.presenceCheck(codeFld.getText())) { //validates password length
            if (((passwordFld.getText().equals(confirmFld.getText())) && codeFld.getText().equals(code)) && type == 1 && ValidationRoutines.studentEmail(emailFld.getText())) {//verifies new student inputs
                ...
                GradePredictor.setStudent(new User(emailFld.getText(), passwordFld.getText(), 1, emailFld.getText().split("@")[0], emailFld.getText().split("@")[0], 0));//creates new student
                GradePredictor.setType(1);
                ...
                GradePredictor.setTeacher(new User(emailFld.getText(), passwordFld.getText(), 0, emailFld.getText().split("@")[0], emailFld.getText().split("@")[0], 0));//creates new teacher
                GradePredictor.setType(0);
                new AboutYou().setVisible(true);//opens about you form
                this.dispose();
            }
        }
    ...
    private void codeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_codeBtnActionPerformed
        ...
        this.code = GradePredictor.getCode(); //gets a random verification code
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) { //if enter key is pressed performs the same code as enterBtnActionPerformed
            if (ValidationRoutines.lengthCheck(0, passwordFld.getText(), 64)
                ...
                if (((passwordFld.getText().equals(confirmFld.getText())) && codeFld.getText().equals(code)) && type == 1) {
                    DatabaseManipulation.signUp(emailFld.getText(), passwordFld.getText(), 1);
                    GradePredictor.setStudent(new User(emailFld.getText(), passwordFld.getText(), 1));
                    GradePredictor.setType(1);
                } else if (((passwordFld.getText().equals(confirmFld.getText())) && codeFld.getText().equals(code)) && type == 0) {
                    DatabaseManipulation.signUp(emailFld.getText(), passwordFld.getText(), 0);
                    GradePredictor.setTeacher(new User(emailFld.getText(), passwordFld.getText(), 0));
                    GradePredictor.setType(0);
                }
